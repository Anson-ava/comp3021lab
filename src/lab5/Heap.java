...
public class Heap<T extends Comparable<T>> {
    ...
    private void heapifyUp() {
        // TODO
    	int x = this.container.size() - 1;
    	
    	while (this.hasParent(x) && this.container.get(x).compareTo(this.container.get(this.getParentIndex(x))) < 0) {
    		this.swap(this.getParentIndex(x), x);
